...
test_remove_single_tag() {
    # Mock existing tags
    mock_function "load_tags" 'declare -gA file_tags=(); declare -gA tag_files=(); file_tags["/tmp/test_remove"]="tag1|tag2|tag3"; tag_files["tag1"]="/tmp/test_remove"; tag_files["tag2"]="/tmp/test_remove"; tag_files["tag3"]="/tmp/test_remove"; return 0'
...
test_remove_non_existent_tag() {
    # Mock existing tags
    mock_function "load_tags" 'declare -gA file_tags=(); declare -gA tag_files=(); file_tags["/tmp/test_remove"]="tag1|tag2"; tag_files["tag1"]="/tmp/test_remove"; tag_files["tag2"]="/tmp/test_remove"; return 0'
...
test_remove_invalid_tag() {
    # Mock empty database
    mock_function "load_tags" 'declare -gA file_tags=(); declare -gA tag_files=(); return 0'
